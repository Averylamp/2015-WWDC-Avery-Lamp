...
class Smith: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        var imageForMask = UIImage(named: "SmithIcon")
        ...
        var text = "Smith is an app created for fun.  It uses the accelerometer to detect knocking on a surface and triggers certain actions."
        ...
        self.pageControl.center = CGPointMake(CGRectGetMidX(scrollView.frame), scrollView.frame.size.height + scrollView.frame.origin.y - 10)
